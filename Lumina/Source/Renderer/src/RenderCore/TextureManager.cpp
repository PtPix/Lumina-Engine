...
// // 2. 从文件加载 (自动调用内存加载)
// // ============================================================================
// FTexture* TextureManager::GetOrCreateTextureFromFile(const std::string& FilePath, ResourceUploader* pUploader)
// {
//     auto it = mTextureCache.find(FilePath);
//     if (it != mTextureCache.end())
//     {
...
// // ============================================================================
// FTexture* TextureManager::GetOrCreateTexture(FDevice* pDevice, ResourceUploader* pUploader, const std::string& Name,
//     const void* pData, uint32_t Width, uint32_t Height, DXGI_FORMAT Format, uint32_t BytesPerPixel)
// {
//     auto FindResult = mTextureCache.find(Name);
//     if (FindResult != mTextureCache.end())
...
//     {
//         FTexture* pTexture = CachePair.second;
//         if (pTexture)
//         {
//             pTexture->Destroy();
//             // 只需要一个 delete！
